...
class Utility:
    ...
    async def help(self, ctx):
        ...
        aq3d_commands = "`char`, `aq3ditem`, `aq3dserver`, `aq3dnews`, `aqwservers`"
        music_command = "`music`"
        ...
        miscellaneous_commands = "`rate`, `actions`, `cmdadd`, `cmd`, `allcmds`, `delcmd (owner only)`,`google`, `wikipedia`"
        welcome_commands = "**__NOTE__**: Will be developed Futher, Please view w!expand welcomemsg, for details.\n\n`welcomemsg`, `togglemsg`"
        further_help = "`expand[command]`"
        #await ctx.send("**WILL BE DEVELOPED FURTHER:**\n"+"```\n"+help_cmd+"```")
        em = discord.Embed()
        em.set_thumbnail(url = self.bot.user.avatar_url)
        em.set_author(name = "Help Menu", icon_url = "http://bestanimations.com/Nature/winter/winter-snow-nature-animated-gif-27.gif")
        ...
        em.add_field(name = "3.AQ3D & AQW: ", value = aq3d_commands ,inline = False)
        ...
        em.add_field(name = "6.Welcoming", value = welcome_commands, inline = False)
    ...
    async def expand(self,ctx, *,args = None):
        ...
        if args == 'user':
            ...
            usage = "w!togglemsg on  < To set it on.\nw!togglemsg off <To set it off.\n\n**Default:** off"
            em = discord.Embed()
            em.set_author(name = "Help Menu ['{}']".format(args), icon_url = "http://bestanimations.com/Science/Chemistry/chemistry-atom-proton-electron-animation-17.gif")
            em.add_field(name = "1.Info:", value = info,inline = False)
            em.add_field(name = "2.Usage: ", value = usage ,inline = False)
